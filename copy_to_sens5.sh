...
cp target/debug/check_read_fast_mapper ~/sens05_home/bin
cp target/debug/check_read_gene_mapper ~/sens05_home/bin
cp target/debug/check_read_genomic_mapper ~/sens05_home/bin
